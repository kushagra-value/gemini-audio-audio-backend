    ...
    async def resume_session(self):
        ...
        try:
            ...
            if self.session:
                ...
                # The session is managed by the async context manager, so we rely on it to close
                self.session = None
            ...
            if self.tasks:
                    ...
                    try:
                        ...
                        print("Previous tasks cancelled successfully.")
                    self.tasks = []
            ...
            print("Resuming session with session resumption config:", CONFIG)
